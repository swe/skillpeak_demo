    ...
    <section className="relative">
      <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
        <div className="flex flex-col items-center text-center">
          <h1 className="mb-8 text-[var(--color-primary-dark)] text-5xl font-extrabold md:text-6xl">
            Welcome to SkillPeak Academy!
          </h1>
          <h2 className="mb-8 text-[var(--color-primary)] font-bold">
            Master Accounting and Bookkeeping with Confidence!
          </h2>
          <p className="mb-12 max-w-3xl text-lg text-[var(--color-gray-900)]">
          ...
          <div className="w-full max-w-3xl">
            <h3 className="mb-6 text-[var(--color-primary-dark)] font-bold">Why Choose Us?</h3>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {features.map((feature) => (
                <div key={feature} className="flex items-start gap-3 rounded-lg bg-white p-4 border border-[var(--color-gray-200)]">
                  <span className="flex-shrink-0 h-6 w-6 text-[var(--color-accent)]">✓</span>
                  <span className="text-[var(--color-gray-900)]">{feature}</span>
                </div>
              ))}
            </div>
          </div>
