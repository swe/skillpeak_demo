      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="h-56 w-[480px] rounded-full border-[20px] border-teal-500 blur-3xl will-change-[filter]" />
          </div>
          ...
          <div className="px-4 py-12 md:px-12 md:py-20">
            ...
            <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
              <a
                className="btn group mb-4 w-full bg-teal-600 text-white shadow-sm hover:bg-teal-700 sm:mb-0 sm:w-auto"
                href="#0"
              >
                <span className="relative inline-flex items-center">
                  Start Free Trial{" "}
                  <span className="ml-1 tracking-normal text-teal-200 transition-transform group-hover:translate-x-0.5">
                    -&gt;
                  </span>
                </span>
              </a>
